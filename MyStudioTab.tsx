                ...
                <section className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4 block">Banner do Estabelecimento</span>
                    ...
                    <div className="space-y-4">
                      <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4 block">Logotipo</span>
...
export default function MyStudioTab() {
  const {
    userRole, merchantProfile, setMerchantProfile,
    ...
    handleCreateNewProduct, handleUpdateMenuCategory,
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <label className="cursor-pointer block">
            ...
            />
            <div className="w-full bg-slate-50 border border-dashed border-slate-200 rounded-3xl px-6 py-4 font-bold text-sm flex items-center gap-3 hover:border-primary/50 transition-colors">
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-1">
        ...
        <label className="cursor-pointer block">
          ...
          />
          <div className="w-full bg-slate-50 border border-dashed border-slate-200 rounded-3xl px-6 py-4 font-bold text-sm flex items-center gap-3 hover:border-primary transition-colors">
