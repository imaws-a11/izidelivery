...
export default function DynamicRatesTab() {
  const {
    dynamicRatesState, isAddingPeakRule, setIsAddingPeakRule, newPeakRule, setNewPeakRule, newZoneData, setNewZoneData, selectedZoneForMap, setSelectedZoneForMap, mapSearch, setMapSearch, isGeolocating, setIsGeolocating, mapCenterView, setMapCenterView, fixedGridCenter, setFixedGridCenter, selectedHexagons, setSelectedHexagons, hexGrid, getHexPath, isLoaded, mapsLoadError, handleAddPeakRule, handleRemovePeakRule, handleAddZone, handleRemoveZone
  } = useAdmin();
