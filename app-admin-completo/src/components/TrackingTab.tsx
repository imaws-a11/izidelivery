...
import { mapContainerStyle, uberStyle } from '../constants/mapStyles';
...
export default function TrackingTab() {
  ...
  const onlineDriversWithCoords = useMemo(
    () => onlineDrivers.filter(driver => (driver.lat && driver.lng) || (driver.current_lat && driver.current_lng)),
    [onlineDrivers]
  );
    ...
    <div className="fixed inset-0 z-0 h-full w-full overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        {mapsLoadError ? (
          ...
          <div className="w-full h-full bg-[#0e1626] animate-pulse flex items-center justify-center">
            <span className="text-slate-500 font-black uppercase tracking-[0.5em] italic text-xs">Sincronizando GIS Uber Style...</span>
          </div>
        )}
      </div>

      {/* Floating Command Center Overlay */}
      <div className="absolute top-8 right-8 z-50 flex flex-col items-end gap-4 pointer-events-none">
        <motion.div 
          layout
      ...
      <AnimatePresence>
        {selectedTrackingItem && (
          <motion.div
            ...
            className="absolute top-8 left-8 z-[60] w-96 bg-slate-900/95 backdrop-blur-3xl p-10 rounded-[48px] border border-white/10 shadow-2xl"
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-10">
               <div className="bg-white/5 p-5 rounded-[28px] border border-white/5 text-center">
                  ...
                  <p className="text-xs font-black text-emerald-500 uppercase">Em Rota</p>
               </div>
               <div className="bg-white/5 p-5 rounded-[28px] border border-white/5 text-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button className="w-full py-5 bg-primary text-slate-900 rounded-[24px] font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primary/20 flex items-center justify-center gap-3 active:scale-95 transition-all">
