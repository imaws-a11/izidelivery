...
export default function UsersTab() {
  const {
    usersList, stats, fetchUsers, handleUpdateUserStatus, handleDeleteUser, isLoadingList, session, globalSettings
  } = useAdmin();

  const [unused, setUnused] = useState(1.0);
                    ...
                    <div className="bg-white dark:bg-slate-900 p-8 rounded-[40px] border border-slate-200 dark:border-slate-800 relative overflow-hidden flex flex-col min-h-[500px]">
                         ...
                         <div className="mb-6 text-center md:text-left">
                             ...
                             <div className="flex flex-col md:flex-row md:items-baseline gap-2">
                                 ...
                                 <p className="text-sm font-black text-emerald-500 italic opacity-80">~ R$ {(Number(selectedUser.izi_coins || 0) * (globalSettings?.izi_coin_value || 1.0)).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                             </div>
                         </div>
              ...
              <div className="mt-auto px-4 pb-4">
                   <div className="p-8 rounded-[40px] bg-rose-500/5 border border-rose-500/10 flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="text-center md:text-left">
                             <p className="text-[9px] font-black text-rose-500/60 uppercase tracking-widest mb-1 italic">Zona de Risco â€¢ Área Crítica</p>
