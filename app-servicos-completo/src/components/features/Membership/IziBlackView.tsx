...
export const IziBlackView = () => {
  ...
  const perks = [
    ...
    { id: 'cashback', label: 'Cashback 1%', icon: 'monetization_on', active: true },
          ...
          <div className="flex gap-4 overflow-x-auto no-scrollbar pb-4 pr-10">
            {perks.map((perk, i) => (
              <motion.div
                ...
                className={`shrink-0 flex items-center gap-4 py-4 px-8 rounded-[30px] border transition-all cursor-pointer ${activePerkDetail === perk.id
