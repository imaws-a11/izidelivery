...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  const menuItems = [
    ...
    { icon: "notifications", label: "Notificações", action: () => {}, badge: 1 },
    ...
    { icon: "moped", label: "Seja um entregador", action: () => {} },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F7F7F7] text-zinc-900 pb-32">
      {/* HEADER */}
      <header className="bg-white px-6 pt-12 pb-6 flex items-center justify-between border-b border-zinc-100">
