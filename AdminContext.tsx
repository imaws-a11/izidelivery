...
export interface AdminContextType {
  ...
  handleSaveStudioInfo: (targetItem: Merchant | MerchantProfile) => Promise<void>;
  ...
  renderDevicePreview: (targetItem: Merchant | MerchantProfile | null, targetProducts: Product[], targetCategories: any[]) => React.ReactNode;
  renderStudioPanel: (targetItem: Merchant | MerchantProfile, updateItem: (updated: Merchant | MerchantProfile) => void) => React.ReactNode;
}
