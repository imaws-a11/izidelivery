...
const WithdrawHistoryView = React.memo<WithdrawHistoryViewProps>(({ 
    ...
    return (
        ...
        >
            <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl px-5 pt-8 pb-4 flex items-center justify-between border-b border-zinc-100 shrink-0">
                <button 
                            ...
                            return (
                                ...
                                >
                                    <motion.div 
                                        ...
                                        className="bg-white rounded-[30px] p-6 border border-zinc-100 flex items-center gap-5 relative overflow-hidden transition-all active:scale-95 cursor-pointer hover:border-yellow-400/30 shadow-sm h-full"
                                        style={sClayLight}
                                    >
                                        <div className={`size-14 rounded-2xl flex items-center justify-center border shadow-sm shrink-0 ${
