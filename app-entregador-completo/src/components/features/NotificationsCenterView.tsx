...
const NotificationsCenterView: React.FC<NotificationsCenterViewProps> = ({ driverId, onBack, getSecureToken }) => {
 ...
 {/* Header Interno */}
 <div className="px-6 py-6 flex items-center justify-between bg-white border-b border-zinc-100 sticky top-0 z-20">
 <motion.button 
 whileTap={{ scale: 0.9 }}
 onClick={onBack}
 className="size-11 rounded-2xl bg-zinc-50 flex items-center justify-center border border-zinc-100 "
 >
 ...
 <div className="size-24 rounded-xl bg-white border border-zinc-100 flex items-center justify-center text-zinc-200 ">
