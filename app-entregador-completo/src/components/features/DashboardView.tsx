...
export const DashboardView = React.memo(({ 
    ...
    return (
        <div className="flex-1 flex flex-col h-full bg-zinc-50 relative overflow-hidden font-['Plus_Jakarta_Sans'] isolate">
            ...
            >
                {isRefreshing ? (
                    <div className="bg-zinc-900 text-yellow-400 size-12 rounded-full flex items-center justify-center shadow-2xl border-4 border-zinc-800">
                        <Icon name="refresh" className="animate-spin text-xl" />
                    </div>
                ) : (
                    <div className="bg-zinc-900 text-white px-5 py-3 rounded-full flex items-center gap-3 shadow-2xl font-black text-[10px] uppercase tracking-widest border border-zinc-800">
