      ...
      >
        <div className="px-6 space-y-10">
          ...
          <motion.div 
            ...
            className="bg-white rounded-3xl p-6 border border-zinc-100 flex items-center justify-between shadow-xl shadow-zinc-200/40 active:scale-[0.98] transition-all mx-1"
            onClick={() => setActiveTab('earnings')}
          >
            <div className="flex items-center gap-4">
              <div className="size-14 rounded-2xl bg-zinc-900 flex items-center justify-center text-yellow-400 shadow-lg shadow-black/20">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-sm font-black text-zinc-300">R$</span>
                  <p className="text-3xl font-black text-zinc-950 tracking-tighter leading-none">
                    {stats.balance.toFixed(2).replace('.', ',')}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-50 rounded-xl border border-zinc-100 group">
              <span className="text-[10px] font-black text-zinc-900 uppercase tracking-widest group-hover:text-yellow-600 transition-colors">Detalhes</span>
              <Icon name="chevron_right" size={18} className="text-zinc-300 group-hover:text-yellow-500 transition-all" />
            </div>
          </motion.div>
