...
export class LocalErrorBoundary extends React.Component<Props, State> {
 ...
 return (
 <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-zinc-50 rounded-xl m-4 border-2 border-dashed border-zinc-200">
 <div className="size-16 rounded-3xl bg-rose-50 flex items-center justify-center mb-6 ">
 ...
 className="px-8 h-12 bg-zinc-900 text-white rounded-full font-black text-[10px] uppercase tracking-[0.2em] active:scale-95 transition-all"
 >
 Tentar Recarregar
 </button>
