...
const SplashScreen: React.FC<SplashScreenProps> = ({ finishLoading }) => {
  const [loadingText, setLoadingText] = useState('Inicializando Terminal...');
  ...
  useEffect(() => {
    ...
    const textTimer = setTimeout(() => setLoadingText('Sincronizando satélites...'), 1000);
    const textTimer2 = setTimeout(() => setLoadingText('Estabilizando terminal...'), 2000);
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full px-8">
        ...
        {/* Mascote Robô - Flutuação Elegante */}
        <motion.div
        ...
        {/* Logotipo Texto Aumentado e Limpo */}
        <motion.div
