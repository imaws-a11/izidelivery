...
export class ErrorBoundary extends React.Component<Props, State> {
 ...
 <div className="size-20 rounded-xl bg-rose-500/10 border border-rose-500/20 flex items-center justify-center mb-8 ">
 ...
 <div className="w-full max-w-sm bg-zinc-900/50 border border-white/5 rounded-xl p-6 mb-10 text-left ">
 ...
 className="h-16 bg-yellow-400 text-black font-black uppercase tracking-[0.2em] text-[11px] rounded-xl active:scale-95 transition-all border-t border-white/40"
 >
 Tentar Novamente
 </button>
 ...
 className="h-14 bg-zinc-900 text-zinc-400 font-black uppercase tracking-[0.2em] text-[10px] rounded-xl border border-white/5 active:scale-95 transition-all"
 >
